...
const filterByPrice = function (products, price) {
  return products.filter(function (product) { return product.price > price; });
};
...
const filterByMathGrade = function (students, grade) {
  return students.filter(function (student) { return student.grades.math > grade; });
};
...
const filterBySalary = function (employees, salary) {
  return employees.filter(function (employee) { return employee.salary > salary; });
};
